...
Shader "PBSDisplaceSpecularTransparent"
{
	Properties{
...
#pragma surface surf_specular StandardSpecular alpha fullforwardshadows vertex:vertDisplace addshadow
#define _GLOSSYENV 1
