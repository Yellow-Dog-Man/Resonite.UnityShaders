Shader "PBSMultiUV"
{
    Properties
    {
		...
		_MetallicUV ("MetallicMap UV", Float) = 0
    }
...
#endif
#ifdef _METALLICMAP
			o.metallic_coord = TRANSFORM_TEX(GetUV(v, _MetallicUV), _MetallicMap);
#endif
#ifdef _OCCLUSION
...
#ifdef _METALLICMAP
			half4 m = tex2D(_MetallicMap, IN.metallic_coord);
