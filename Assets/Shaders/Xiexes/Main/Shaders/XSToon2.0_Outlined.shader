Shader "Xiexe/XSToon2.0_Outlined"
{
	Properties
	{
		//[Enum(Off, 0, On, 1)] _VertexColorAlbedo ("Vertex Color Albedo", Int) = 0
		//[Enum(Separated, 0, Merged, 1)] _TilingMode ("Tiling Mode", Int) = 0
		_SrcBlendBase("SrcBlendBase", Float) = 1
		_DstBlendBase("DstBlendBase", Float) = 0
		_SrcBlendAdd("SrcBlendAdd", Float) = 1
		_DstBlendAdd("DstBlendAdd", Float) = 1
			...
			/* _DetailNormalMap("Detail Normal Map", 2D) = "bump" {}
			 ...
			 _MatcapTint("Matcap Tint", Color) = (1,1,1,1)
				 ...
				 _EmissionColor("Emission Color", Color) = (0,0,0,0)
					 ...
					 [Enum(Lit, 0, Emissive, 1)]_OutlineEmissive("Outline Emission", Int) = 0
		...
		SubShader
					 {
						 ...
						 Pass
						 {
							 Blend[_SrcBlendBase][_DstBlendBase]
							 ZWrite[_ZWrite]
						 ...
						 #pragma multi_compile _ Cutout AlphaBlend Transparent

						 #pragma multi_compile _ VERTEX_COLOR_ALBEDO

						 //#pragma multi_compile _ OUTLINE_ALBEDO_TINT
						 //#pragma multi_compile OUTLINE_LIT OUTLINE_EMISSIVE

						 #pragma multi_compile _ NORMAL_MAP

						 #pragma multi_compile _ EMISSION_MAP

						 #pragma multi_compile _ OCCLUSION_METALLIC
						 //#pragma multi_compile _ METALLICGLOSS_MAP
						 //#pragma multi_compile _ OCCLUSION_MAP

						 #pragma multi_compile _ RAMPMASK_OUTLINEMASK_THICKNESS
						 //#pragma multi_compile _ RAMP_MASK
						 //#pragma multi_compile _ OUTLINE_MASK
						 //#pragma multi_compile _ THICKNESS_MAP

						 #pragma multi_compile _ MATCAP
